            ...
            <div className="navbar-nav ms-auto">
              ...
              <div className="nav-item dropdown">
                ...
                <ul className="dropdown-menu dropdown-menu-dark" style={{width:"100px",backgroundColor:"rgb(7, 137, 177)"}}>
                  <li>
                    <Link className="dropdown-item" to="/admin/drive">
                      Add
                    </Link>
                  </li>
                  <li>
                    <Link className="dropdown-item" to="/admin/managedrive" >
                      Manage
                    </Link>
                  </li>
                </ul>
              ...
              <div className="nav-item dropdown">
                ...
                <ul className="dropdown-menu dropdown-menu-dark" style={{width:"100px",backgroundColor:"rgb(7, 137, 177)"}}>
                  ...
                  <li>
                    <Link className="dropdown-item" to="/admin/managepost">
                      Manage
                    </Link>
                  </li>
                </ul>
              ...
              <Link to="/admin/viewrequest" className="nav-item nav-link">
                Request
              </Link>
